...
# Saida : O programa deve imprimir uma mensagem indicando o progresso do explorador na floresta. Utilize um laço de repetição para simular os passos do explorador. A cada passo, imprima uma mensagem informando a distância percorrida até o momento.


quantidade_passos = int(input("Quantidade de passos: "))

if (quantidade_passos > 0):
    for cont in range(1, quantidade_passos + 1):
        if(cont == 1):
            print("Explorador: 1 passo")
        else:
            print(f"Explorador: {cont} passos")
